...
本文以将介绍远程ADB环境的配置
- [1. 远程ADB环境配置](#1-远程adb环境配置)
	- [1.1 网络拓扑](#11-网络拓扑)
	- [1.2 原理](#12-原理)
	- [1.3 本地ADB环境配置](#13-本地adb环境配置)
	- [1.4 构建服务器-\>本地转发链路(S-\>L)](#14-构建服务器-本地转发链路s-l)
		- [方案1: SSH端口转发](#方案1-ssh端口转发)
		- [方案2: TailScale/EasyTier隧道 (推荐)](#方案2-tailscaleeasytier隧道-推荐)
	- [1.5 构建本地-\>手机的转发链路(L-\>P)](#15-构建本地-手机的转发链路l-p)
	- [1.6 测试](#16-测试)
...
- 步骤1：本地L和服务器S分别部署TailScale/EasyTier,  [TailScale参考tutorial](https://tailscale.com/kb/1017/install)， [EasyTier参考tutorial](https://easytier.cn/guide/introduction.html)
	...
	![EasyTier安装界面](png/easytier_install.png)打开EasyTier,  左下角可以切换中文模式
	![EasyTier主界面](png/easytier_gui.png)

	设置网络名称和密码，然后点击创建新网络，只有网络名和密码匹配才会加入同一个网络，所以网络名设置不要太简单。

	![EasyTier网络配置](png/easytier_gui_config.png)

	滑倒底下 运行网络，本地节点就启动了
	![EasyTier运行网络](png/easytier_gui_run.png)
	...
	- 服务器S节点安装
		...
		![EasyTier节点列表](png/easytier_gui_ip.png)
